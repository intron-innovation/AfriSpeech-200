#!/bin/bash
#SBATCH --job-name=afrispeech_al_clinical
#SBATCH --gres=gpu:rtx8000:2
#SBATCH --cpus-per-gpu=18
#SBATCH --mem=128G
#SBATCH --time=168:00:00         
#SBATCH --partition=long
#SBATCH --error=/home/mila/b/bonaventure.dossou/AfriSpeech-Dataset-Paper/comErrorClinical.txt
#SBATCH --output=/home/mila/b/bonaventure.dossou/AfriSpeech-Dataset-Paper/comOutputClinical.txt
