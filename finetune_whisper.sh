...
#SBATCH --error=/home/mila/c/chris.emezue/AfriSpeech-Dataset-Paper/slurmerror_clinical_%j.txt
#SBATCH --output=/home/mila/c/chris.emezue/AfriSpeech-Dataset-Paper/slurmoutput_clinical_%j.txt
...
python3 src/train/whisper_finetuning.py -c src/config/whisper_clinical.ini
