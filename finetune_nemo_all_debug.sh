#!/bin/bash
#SBATCH --job-name=finetune_nemo_all
...
python3 src/train/nemo_ctc_finetuning.py --config src/config/nemo_all_debug.ini
#python3 src/train/nemo_ctc_finetuning.py --config src/config/nemo_all_debug_ctc.ini