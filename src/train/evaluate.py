...
if __name__ == "__main__":
    ...
    filename = 'Top-{}_AL_Round_{}_Mode_{}_WERS.csv'.format(k, 2, 'most') # change manually the round here 0, 1, 2
    filepath = os.path.join('/home/mila/b/bonaventure.dossou/AfriSpeech-Dataset-Paper/data/', filename)
    for mc_round in mc_dropout_rounds_list:
        ...
        samples_uncertainty = run_inference(model, augmentation_dataloader,
                                                mode='least', mc_dropout_rounds=mc_round)
